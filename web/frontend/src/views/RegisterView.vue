<template>
  <div class="auth-container">
    <div class="auth-card">
      ...
      <div v-if="isSingleUserMode" class="single-user-notice">
        <p>单用户模式已启用，无需注册</p>
        <router-link to="/login" class="submit-btn">返回登录</router-link>
      </div>
...
.single-user-notice p {
  color: #666;
  margin: 0;
}

.single-user-notice .submit-btn {
