	...
	<div class="share-page-view">
		...
		<div v-else-if="share" class="share-content">
			<article class="article-container">
				...
				<div class="code-section" v-if="share.article.code">
					<div class="code-header">
						<h3>代码</h3>
						<button class="run-btn" :disabled="isRunning || !canRun" @click="runCode">
							{{ isRunning ? '运行中...' : '运行' }}
						</button>
					</div>
				...
				<div v-if="showHtmlPreview" class="preview-section">
					...
					<div class="preview-container">
						<iframe ref="previewFrame" class="preview-iframe" sandbox="allow-scripts" :srcdoc="previewHtml"></iframe>
					</div>
				</div>
			</article>
			...
			<div class="comments-section">
				...
				<CommentForm ref="commentFormRef" :submitting="commentSubmitting" @submit="submitComment" />
			</div>
		</div>
	</div>
</template>
