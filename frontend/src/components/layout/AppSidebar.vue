...
<template>
	<aside class="app-sidebar" :class="{ collapsed: !sidebarOpen }">
		...
		<div class="sidebar-content" :class="{ hidden: !sidebarOpen }">
			...
			<div class="tags-section">
				...
				<div v-else class="tag-list">
					<button v-for="tag in sortedTags" :key="tag.id" class="tag-item" :class="{ active: selectedTagId === tag.id }"
		...
		<div class="sidebar-collapsed" :class="{ hidden: sidebarOpen }">
			<button class="new-article-btn-mini" @click="createNewArticle" title="New Quill">
				+
			</button>
		</div>
	</aside>
