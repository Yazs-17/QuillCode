...
import { DownloadGuideDialog } from '../download'
...
const showDownloadButton = computed(() => isOnlineMode())
...
function handleExported (data) {
	uiStore.showToast(`导出成功: ${data.fileName}`, 'success')
}
...
<template>
	<header class="app-header">
		...
		<nav v-if="showNav && isAuthenticated" class="header-nav">
			...
			<button class="nav-link export-btn-nav" @click="openExportDialog">
				<span class="nav-icon css-icon icon-download"></span>
		...
		<div class="header-right">
			...
			>
				...
				<span class="download-text">下载完整版</span>
			</button>
