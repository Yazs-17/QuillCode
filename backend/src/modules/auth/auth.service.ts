...
export class AuthService {
  ...
  async login(
    ...
    console.log(
      `[AuthDebug] Login attempt for username: ${username}. User found: ${!!user}`,
    );

    if (!user) {
      console.log(`[AuthDebug] User not found: ${username}`);
    ...
    console.log(
      `[AuthDebug] Password valid for ${username}: ${isPasswordValid}`,
    );
